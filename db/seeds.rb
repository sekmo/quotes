Quote.create! (
  [
    {
      text: "The secret of change is to focus all of your energy, not on fighting the old, but on \
      building the new.",
      author: "Socrates"
    },
    {
    ...
    {
      text: "The greatest challenge to any thinker is stating the problem in a way that will \
      allow a solution.",
    ...
    },
    {
      ...
      doing programming or operating the application of the machines. We are the masters. They \
      are the slaves.",
